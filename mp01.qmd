...
ggplot(india_trend, aes(x = date, y = total_hours_views_india)) +
  ...
  labs(title = "Monthly viewing hours across India-favorite titles (global hours).",x = "Month", y = "Total hours viewed (titles popular in India)") +
...
ggplot(india_top10_weeks, aes(x = show_title, y = total_weeks_top10_india)) +
  geom_col(fill = "red") +
  coord_flip() +
  labs(title = "Top 10 India-favorite titles by weeks.",x = NULL, y = "Weeks in India Top 10") +
  theme_minimal(base_size = 13)
...
* [Worldometer](https://www.worldometers.info/world-population/india-population/)
